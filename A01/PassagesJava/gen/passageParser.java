...
public class passageParser extends Parser {
	...
	public static class PruleContext extends ParserRuleContext {
		public TerminalNode CHAR() { return getToken(passageParser.CHAR, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof passageListener ) ((passageListener)listener).enterPrule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof passageListener ) ((passageListener)listener).exitPrule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof passageVisitor ) return ((passageVisitor<? extends T>)visitor).visitPrule(this);
